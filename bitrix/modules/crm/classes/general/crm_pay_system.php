...
class CCrmPaySystem
{
	...
	private static $arCrmCompatibleActs = array('bill', 'billua', 'billen', 'billde', 'billla', 'billkz', 'billby', 'paypal', 'yandexinvoice', 'yandexreferrer', 'alfabankb2b');
	...
	public static function rewritePSCorrByRqSource($personTypeId, &$params, $options = array())
	{
		...
		if (!empty($psaCode))
		{
			...
			if (!empty($curPsLocalization)
				&& in_array($curPsLocalization, array('ru', 'de', 'en', 'la', 'ua', 'kz', 'by'), true))
			{
