...
class Mail
{
	...
	protected function fillMessageBody($invoice)
	{
		...
		$body = \CCrmTemplateManager::PrepareTemplate($body, \CCrmOwnerType::Invoice, $invoice['ID']);
	...
	protected function fillMessageSubject($invoice)
	{
		...
		if (strlen($subject) > 0)
		{
			$subject = \CCrmTemplateManager::PrepareTemplate($subject, \CCrmOwnerType::Invoice, $invoice['ID']);
		}
	...
	public function sendInvoice()
	{
		...
		$fields = array(
			...
			'STORAGE_ELEMENT_IDS' => array($attachmentId),
