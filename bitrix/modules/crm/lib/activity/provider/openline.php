	...
	public static function renderView(array $activity)
	{
		...
		return '<div class="crm-task-list-chat">
			<div class="crm-task-list-chat-inner">
				...
				<div class="webform-small-button webform-small-button-green crm-task-list-chat-button" onclick="top.BXIM.openMessenger(\'imol|'.$activity['PROVIDER_PARAMS']['USER_CODE'].'\')">'.Loc::getMessage('IMOPENLINES_ACTIVITY_PROVIDER_SESSION_RENDER_START').'</div>
			</div>
		</div>';
	}
