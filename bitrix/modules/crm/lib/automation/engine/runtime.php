...
{
	protected $target;
	protected $startedTemplates = array();
	...
	private function setStarted($id, $status)
	{
		$this->startedTemplates[$id] = $status;
	}

	private function isStarted($id, $status)
	{
		return (isset($this->startedTemplates[$id]) && $status == $this->startedTemplates[$id]);
	}
}