...
class DuplicateIndexType
{
	...
	const RQ_INN = 1024;
	const RQ_OGRN = 2048;
	const RQ_OGRNIP = 4096;
	const RQ_BIN = 8192;
	const RQ_EDRPOU = 16384;
	const RQ_VAT_ID = 32768;
	//       reserved 65536
	//       reserved 131072
	//       reserved 262144
	//       reserved 524288
	const RQ_ACC_NUM = 1048576;
	const RQ_IBAN = 2097152;
	const RQ_IIK = 4194304;

	const BANK_DETAIL = 7340032; /*  RQ_ACC_NUM|RQ_IBAN|RQ_IIK  */
	const REQUISITE = 64512; /*  RQ_INN|RQ_OGRN|RQ_OGRNIP|RQ_BIN|RQ_EDRPOU|RQ_VAT_ID  */
	const COMMUNICATION = 1020; /*  COMMUNICATION_PHONE|COMMUNICATION_EMAIL|COMMUNICATION_FACEBOOK|
									COMMUNICATION_TELEGRAM|COMMUNICATION_VK|COMMUNICATION_SKYPE|COMMUNICATION_BITRIX24|
									COMMUNICATION_OPENLINE  */
	const DENOMINATION = 3; /*  PERSON|ORGANIZATION  */
	const ALL = 7405567;  /*  PERSON|ORGANIZATION|
							COMMUNICATION_PHONE|COMMUNICATION_EMAIL|COMMUNICATION_FACEBOOK|COMMUNICATION_TELEGRAM|
							COMMUNICATION_VK|COMMUNICATION_SKYPE|COMMUNICATION_BITRIX24|COMMUNICATION_OPENLINE|
							RQ_INN|RQ_OGRN|RQ_OGRNIP|RQ_BIN|RQ_EDRPOU|RQ_VAT_ID|RQ_ACC_NUM|RQ_IBAN|RQ_IIK  */
