	...
	?>
		...
		<div class="crm-button-edit-left-send-container">
			<div class="crm-button-edit-left-send-inner">
				<?if ($arParams['IFRAME']):?>
					<input type="submit" name="submit_apply" class="crm-button-edit-left-send-confirm webform-small-button webform-small-button-accept" value="<?=Loc::getMessage('CRM_WEBFORM_EDIT_APPLY')?>">
				<?else:?>
				...
				<?endif;?>
				<a id="CRM_BUTTON_EDIT_TO_LIST_BOTTOM" href="<?=htmlspecialcharsbx($arResult['PATH_TO_BUTTON_LIST'])?>" class="crm-button-edit-left-send-back webform-small-button webform-small-button-transparent"><?=Loc::getMessage('CRM_WEBFORM_EDIT_SELECT_BACK_TO_LIST')?></a>
			</div>
