									...
									<div class="crm-entity-widget-content-block crm-entity-widget-content-block-field-select">
										...
										<div class="crm-entity-widget-content-block-inner">
											<div class="crm-entity-widget-content-block-select">
												<select class="crm-entity-widget-content-select" id="add_classifier_currency_id" name="add_classifier_currency_id" size="8">
									...
									<div class="crm-entity-widget-content-block crm-entity-widget-content-block-field-text">
										...
										<div class="crm-entity-widget-content-block-inner">
											<table class="crm-block-inner-table">
												<tr>
													<td width="43%" class="crm-block-inner-table-first-td">
													...
													<td width="43%" class="crm-block-inner-table-middle-td">
						...
						?>
							<div class="crm-entity-card-widget">
								...
								<div class="crm-entity-widget-content">
									...
									<table class="crm-block-inner-table">
										<tr>
											<td class="crm-block-inner-table-first-td" width="32%">
												<div class="crm-entity-widget-content-block crm-entity-widget-content-block-field-text">
													<div class="crm-entity-widget-content-block-title"><?= Loc::getMessage('CRM_CURRENCY_CLASSIFIER_FIELD_FORMAT_TEMPLATE')?></div>
													<div class="crm-entity-widget-content-block-inner">
														<div class="crm-entity-widget-content-block-select">
															<select class="crm-entity-widget-content-select" id="edit_format_template_<?= HtmlFilter::encode($key);?>"
											...
											<td class="crm-block-inner-table-middle-td" width="32%">
												<div class="crm-entity-widget-content-block crm-entity-widget-content-block-field-text">
											...
											<td class="crm-block-inner-table-last-td" width="32%">
												<div class="crm-entity-widget-content-block crm-entity-widget-content-block-field-text">
													<div class="crm-entity-widget-content-block-title"><?= Loc::getMessage('CRM_CURRENCY_CLASSIFIER_FIELD_SIGN_POSITION')?></div>
													<div class="crm-entity-widget-content-block-inner">
														<div class="crm-entity-widget-content-block-select">
															<select class="crm-entity-widget-content-select" id="edit_sign_position_<?= HtmlFilter::encode($key);?>"
												...
												<table class="crm-block-inner-table">
													<tr>
														<td class="crm-block-inner-table-first-td" width="65%">
															<div class="crm-entity-widget-content-block-select">
																<select class="crm-entity-widget-content-select" id="edit_thousands_variant_<?= HtmlFilter::encode($key);?>"
																		name="edit_thousands_variant_<?= HtmlFilter::encode($key);?>">
