...
if(typeof(BX.CrmHistory) === "undefined")
{
	...
	BX.CrmHistory.prototype.createItem = function(data)
	{
		...
		{
			//For activity we render standard Activity item with mark text
			var associatedEntityTypeId = BX.prop.getInteger(data, "ASSOCIATED_ENTITY_TYPE_ID", 0);
			if(associatedEntityTypeId === BX.CrmEntityType.enumeration.activity && BX.type.isPlainObject(data["ASSOCIATED_ENTITY"]))
			{
				data["TYPE_ID"] = BX.CrmTimelineType.activity;
				data["TYPE_CATEGORY_ID"] = BX.prop.getInteger(
					data["ASSOCIATED_ENTITY"],
					"TYPE_ID",
					0
				);
				data["ASSOCIATED_ENTITY"]["MARK_TYPE_ID"] = typeCategoryId;
...
if(typeof BX.CrmTimelineSmsEditor === "undefined")
{
	...
	BX.CrmTimelineSmsEditor.prototype.initSenderSelector = function()
	{
		...
		{
			if (this._senders[i].canUse && (this._senders[i].id === defaultSenderId || !defaultSender))
			{
		...
		var settings =
			{
				...
				"subject": BX.prop.getString(this._entityData, "SUBJECT", ""),
				"descriptionBBCode": BX.prop.getString(this._entityData, "DESCRIPTION_BBCODE", ""),
				"description": BX.prop.getString(this._entityData, "DESCRIPTION_RAW", ""),
...
if(typeof(BX.CrmTimelineOpenLineAction) === "undefined")
{
	...
	BX.CrmTimelineOpenLineAction.prototype.onClick = function()
	{
		...
		if(slug !== "")
		{
			window.top['BXIM'].openMessenger(slug);
		}
	};
...
if(typeof(BX.CrmHistoryItem) === "undefined")
{
	...
	BX.CrmHistoryItem.prototype.view = function()
	{
	};
...
if(typeof(BX.CrmHistoryItemComment) === "undefined")
{
	...
	{
		var rawComment = this.getTextDataParam("COMMENT", "");
		var comment = BX.util.htmlspecialchars(rawComment).replace(/\r\n|\r|\n/g, "<br/>");
	...
	BX.CrmHistoryItemComment.prototype.onExpandButtonClick = function(e)
	{
		...
		{
			contentWrapper.style.maxHeight = contentWrapper.scrollHeight + 130 + "px";
		...
		{
			contentWrapper.style.maxHeight = contentWrapper.clientHeight + "px";
...
if(typeof(BX.CrmHistoryItemSender) === "undefined")
{
	...
	{
		var entityData = this.getAssociatedEntityData();
		var description = this.getMessage('title') + ': ' + this.getDataSetting('letterTitle');
...
if(typeof(BX.CrmScheduleItem) === "undefined")
{
	...
	BX.CrmScheduleItem.prototype.prepareContextMenuButton = function()
	{
	...
	BX.CrmScheduleItem.prototype.onContextMenuButtonClick = function(e)
	{
	...
	BX.CrmScheduleItem.prototype.openContextMenu = function()
	{
	...
	BX.CrmScheduleItem.prototype.closeContextMenu = function()
	{
	...
	BX.CrmScheduleItem.prototype.prepareContextMenuItems = function()
	{
		return [];
	};
	BX.CrmScheduleItem.prototype.onContextMenuShow = function()
	{
		this._isContextMenuShown = true;
		BX.addClass(this._contextMenuButton, "active");
	};
	BX.CrmScheduleItem.prototype.onContextMenuClose = function()
	{
		if(this._contextMenu)
		{
	...
	BX.CrmScheduleItem.prototype.onContextMenuDestroy = function()
	{
		this._isContextMenuShown = false;
...
if(typeof(BX.CrmCommentAnimation) === "undefined")
{
	...
	BX.CrmCommentAnimation.prototype =
	{
		...
		finish: function()
		{
			...
			this._anchor.parentNode.insertBefore(this._node, this._anchor.nextSibling);
			setTimeout(
				BX.delegate(function() { BX.removeClass(this._node, 'crm-entity-stream-section-animate-start'); }, this),
				0
			);
		}
	};
