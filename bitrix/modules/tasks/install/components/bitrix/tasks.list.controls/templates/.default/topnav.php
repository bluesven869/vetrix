...
if ($arParams["SHOW_SECTIONS_BAR"] === "Y")
{
	...
	$counters = array(
		"view_role_responsible" => "tasks_my",
		"view_role_accomplice" => "tasks_acc",
		"view_role_auditor" => "tasks_au",
		"view_role_originator" => "tasks_orig"
	);
	...
	foreach ($arResult["VIEW_STATE"]["ROLES"] as $roleCodename => $arRoleData)
	{
		...
		{
			$counter = intval($arResult["VIEW_COUNTERS"]["ROLES"][$roleCodename]["TOTAL"]["COUNTER"]);
		}
