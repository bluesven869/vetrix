			...
			'ROLES' => array(
				'VIEW_ROLE_RESPONSIBLE' => array(
					'TOTAL' => array(
						...
						'COUNTER_ID' => $oListCtrl->resolveCounterIdByRoleAndCategory(CTaskListState::VIEW_ROLE_RESPONSIBLE)
					)
				),
				'VIEW_ROLE_ACCOMPLICE' => array(
					'TOTAL' => array(
						'COUNTER' => $oListCtrl->getUserRoleCounter(CTaskListState::VIEW_ROLE_ACCOMPLICE),
						'COUNTER_ID' => $oListCtrl->resolveCounterIdByRoleAndCategory(CTaskListState::VIEW_ROLE_ACCOMPLICE)
					)
				),
				'VIEW_ROLE_ORIGINATOR' => array(
					'TOTAL' => array(
						'COUNTER' => $oListCtrl->getUserRoleCounter(CTaskListState::VIEW_ROLE_ORIGINATOR),
						'COUNTER_ID' => $oListCtrl->resolveCounterIdByRoleAndCategory(CTaskListState::VIEW_ROLE_ORIGINATOR)
					)
				),
				'VIEW_ROLE_AUDITOR' => array(
					'TOTAL' => array(
						'COUNTER' => $oListCtrl->getUserRoleCounter(CTaskListState::VIEW_ROLE_AUDITOR),
						'COUNTER_ID' => $oListCtrl->resolveCounterIdByRoleAndCategory(CTaskListState::VIEW_ROLE_AUDITOR)
					)
				)
			)
		);
...
$arResult["DESTINATION"] = Bitrix\Tasks\Integration\SocialNetwork::getLogDestination();
