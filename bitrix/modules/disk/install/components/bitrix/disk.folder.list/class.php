...
class CDiskFolderListComponent extends DiskComponent
{
	...
	protected function processActionDefault()
	{
		...
		{
			$PATH_TO_DISK_VOLUME = $this->arParams["PATH_TO_USER_DISK_VOLUME"];
		}
		elseif(!empty($this->arParams["PATH_TO_DISK_VOLUME"]))
		{
			$PATH_TO_DISK_VOLUME = $this->arParams["PATH_TO_DISK_VOLUME"];
		}
		...
		$this->arResult = array(
			...
			'PATH_TO_DISK_VOLUME' => CComponentEngine::MakePathFromTemplate($PATH_TO_DISK_VOLUME, array('ACTION' => '', 'user_id' => $this->getUser()->getId())),
		);
