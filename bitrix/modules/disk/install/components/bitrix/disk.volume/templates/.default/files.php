...
<div class="bx-disk-volume-structure-path">
	...
	<? if (count($arResult['BREAD_CRUMB']) > 0): ?>
		...
		<span class="bx-disk-volume-bread-crumbs-item-container">
			<a href="<?= $component->getActionUrl(array('action' => $component::ACTION_STORAGE, 'storageId' => $arResult['STORAGE_ID'])); ?>" class="bx-disk-volume-bread-crumbs-item-link">
				<?= Loc::getMessage("DISK_VOLUME_DISK") ?>
			</a>
		</span>
		*/ ?>
