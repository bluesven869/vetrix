...
$jsLibraries = array('crm_visit_tracker');
				...
				<div class="crm-entity-stream-section-content crm-entity-stream-section-content-new">
					...
					<div id="<?=htmlspecialcharsbx($commentContainerID)?>" class="crm-entity-stream-content-new-detail">
						...
						<div class="crm-entity-stream-content-new-comment-btn-container">
							<button id="<?=htmlspecialcharsbx($commentButtonID)?>" class="crm-entity-stream-content-new-comment-submit">
								<?=GetMessage('CRM_TIMELINE_SEND')?>
							</button>
							<span id="<?=htmlspecialcharsbx($commentCancelButtonID)?>" class="crm-entity-stream-content-new-comment-cancel"><?=GetMessage('CRM_TIMELINE_CANCEL_BTN')?></span>
						</div>
					</div>
					<div id="<?=htmlspecialcharsbx($waitContainerID)?>" class="crm-entity-stream-content-wait-detail focus" style="display: none;">
						...
						<div class="crm-entity-stream-content-wait-comment-btn-container">
							<button id="<?=htmlspecialcharsbx($waitButtonID)?>" class="crm-entity-stream-content-wait-comment-submit webform-small-button webform-small-button-blue webform-button-active">
								<?=GetMessage('CRM_TIMELINE_CREATE_WAITING')?>
							</button>
							<span id="<?=htmlspecialcharsbx($waitCancelButtonID)?>" class="crm-entity-stream-content-wait-comment-cancel"><?=GetMessage('CRM_TIMELINE_CANCEL_BTN')?></span>
						</div>
					</div>
