...
use Bitrix\Crm\Authorization\Authorization;
...
class CCrmTimelineComponent extends CBitrixComponent
{
	...
	protected function initialize()
	{
		...
		if($this->entityID > 0 && !Authorization::checkReadPermission($this->entityTypeID, $this->entityID))
		{
		...
		$this->prepareHistoryItems(null, 10);
	...
	public function prepareHistoryItems($lastItemTime, $limit)
	{
		if($this->entityID <= 0)
		{
			return ($this->arResult['HISTORY_ITEMS'] = array());
		}
		...
		return ($this->arResult['HISTORY_ITEMS'] = array_values($items));
	}
}